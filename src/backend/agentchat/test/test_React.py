...
# client = ChatOpenAI(api_key="sk-YOUR-API-KEY", base_url="http://localhost:11000/v1/", model="Qwen2-72B-Instruct")

client = OpenAI(base_url='http://localhost:11000/v1/', api_key='sk-YOUR-API-KEY')
tools = [
    {
        "schemas": "function",
        "function": {
